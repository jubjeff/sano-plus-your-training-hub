...
export default function AuthShell({ badge = "Sano+ workspace", title, subtitle, children, footer }: AuthShellProps) {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-x-hidden px-3 py-10 sm:px-4 sm:py-12">
      ...
      <div className="relative z-10 my-auto w-full max-w-[42rem] animate-fade-in">
        ...
        <div className="section-shell p-4 sm:p-6 lg:p-7">{children}</div>
