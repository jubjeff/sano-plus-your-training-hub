...
export type { SupabaseProfileRecord, SupabaseProfileRole } from "@/integrations/supabase/types";
export type { Database, Tables, TablesInsert, TablesUpdate } from "@/integrations/supabase/database.types";
