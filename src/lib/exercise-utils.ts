...
export function resolveExerciseFromLibrary(
  ...
  return {
    ...
    movementCategory: libraryItem.movementCategory,
    difficultyLevel: libraryItem.difficultyLevel,
    exerciseType: libraryItem.exerciseType,
    mechanicalType: libraryItem.mechanicalType,
    laterality: libraryItem.laterality,
    movementPlane: libraryItem.movementPlane,
